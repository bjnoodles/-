...
\twochs{$\left(\dfrac{1}{3},1\right)$}{$\left(-\infty,\dfrac{1}{3}\right)\cup(1,+\infty)$}{$\left(-\dfrac{1}{3},\dfrac{1}{3}\right)$}{$\left(-\infty,\dfrac{1}{3}\right)\cup\left(\dfrac{1}{3},+\infty\right)$}
...
\qs 函数$f(x)$的图象向右平移一个单位长度，所得图象与$ y=e^x $关于$ y $轴对称，则$f(x)=$\\\mbox{\hspace{1ex}}\hfill\xx
